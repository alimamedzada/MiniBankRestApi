package com.company.MiniBankByUsingSpring.accounts.service.impl;
...
import com.company.MiniBankByUsingSpring.accounts.service.inter.AccountOperationsInter;
...
public class AccountServiceImpl implements AccountServiceInter, AccountOperationsInter {
    ...
    public AccountServiceImpl(TransactionServiceInter transactionService,
    ...
    @Transactional
    @Override
    public boolean transfer(Accounts fromAcc, String toIban, BigDecimal amount,
            String description) {
    ...
    public boolean qucikTransfer(String customerId, String toIban, BigDecimal amount) {
        ...
        if (sourceAccount != null) {
            transfer(sourceAccount, toIban, amount, "Quick Transfer");
        } else {
            throw new InsufficientBalanceException(
